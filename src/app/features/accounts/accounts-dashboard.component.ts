...
import { BofaAccountCardComponent } from '../../shared/components/bofa-account-card/bofa-account-card.component';
...
export class AccountsDashboardComponent implements OnInit, OnDestroy {
  ...
  viewAccountDetails(account: { accountId: string; accountType: string }): void {
  ...
  initiateTransfer(account: { accountId: string }): void {
